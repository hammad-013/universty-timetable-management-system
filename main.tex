...
\textbf{Deployment \& Final Evaluation} & Final deployment and user training. \\ \hline
\end{tabular}
...
\bibitem{joy2021}
B. Joy, "Software Engineering Project: Robo Hatch," \textit{GitHub Repository}, 2021. [Online]. Available: \url{https://github.com/basudebjoy/Software-Engineering-Project-Robo-Hatch/}. [Accessed: Nov. 8, 2025].

\bibitem{uw2012}
University of Washington, "Beer Recommendation System Project Proposal," \textit{CSE403: Software Engineering Course}, 2012. [Online]. Available: \url{https://courses.cs.washington.edu/courses/cse403/12sp/Projects/proposals/brdmstr-proposal.pdf}. [Accessed: Nov. 8, 2025].

\bibitem{techie2021}
H. Techie-Menson and P. Nyagorme, "Design and Implementation of a Web-Based Timetable System for Higher Education Institutions," \textit{International Journal of Computer Applications}, vol. 7, pp. 1--13, 2021.

\bibitem{chatgpt2025}
OpenAI, "ChatGPT (GPT-5 Mini) Prompt Responses," 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].

\bibitem{ai_proposal}
AI prompt, "make a project proposal template in latex as described in given document," OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].

\bibitem{ai_titlepage}
AI prompt, "look at the content of title page, like is it grammatically correct and punctuations too?," OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].

\bibitem{ai_ieee}
AI prompt, "how to add ieee style references in latex?," OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].

\bibitem{ai_tools}
AI prompt, "help me with identifying relevant tools and technology for this project," OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].

\bibitem{ai_methodology}
AI prompt, "which software development methodology should we use for our project, what i think is that this system is complex and faces lot of constraints, so we should utilize iterative methods like scrum and kanban which focuses on continuous feedback and evaluation?," OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].

\bibitem{claude_gantt}
AI prompt, "can you make gantt chart for schedule given below?," Claude (Sonnet 4.5), Nov. 8, 2025. [Online]. Available: \url{https://claude.ai/new/}. [Accessed: Nov. 8, 2025].
