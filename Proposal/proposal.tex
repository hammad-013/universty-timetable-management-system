...
\begin{enumerate}[label={[\arabic*]}, leftmargin=*, align=left, labelwidth=2.3em, itemindent=0em]
    ...
    \item OpenAI, ``ChatGPT (GPT-5 Mini) Prompt Responses,'' 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].
    
    \item AI prompt, ``make a project proposal template in latex as described in given document,'' OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].
    
    \item AI prompt, ``look at the content of title page, like is it grammatically correct and punctuations too?,'' OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].
    
    \item AI prompt, ``how to add ieee style references in latex?,'' OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].
    
    \item AI prompt, ``help me with identifying relevant tools and technology for this project,'' OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].
    
    \item AI prompt, ``which software development methodology should we use for our project, what i think is that this system is complex and faces lot of constraints, so we should utilize iterative methods like scrum and kanban which focuses on continuous feedback and evaluation?,'' OpenAI ChatGPT (GPT-5 Mini), Nov. 8, 2025. [Online]. Available: \url{https://chat.openai.com/}. [Accessed: Nov. 8, 2025].
    
    \item AI prompt, ``can you make gantt chart for schedule given below?,'' Claude (Sonnet 4.5), Nov. 8, 2025. [Online]. Available: \url{https://claude.ai/new/}. [Accessed: Nov. 8, 2025].
\end{enumerate}
